...
public class EmailPlugin
{
     ...
     string emailreceipient)
    {
        ...
        using (var client = new SmtpClient())
        {
            ...
            client.Credentials = new NetworkCredential("xxxxxxxx@GMAIL.COM", "yyyyyyyy"); //yyyyyy

            using (var mailMessage = new MailMessage(
                from: new MailAddress("xxxxxxxx@gmail.com", "AutoGenerated"),
